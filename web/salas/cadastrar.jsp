                        ...
                        <div class="col-lg-12 mt-4">
                            <form action="cadastrar" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="descricao" name="descricao" placeholder="Descrição da Sala" required>
                                </div>

                                <div class="form-group">
                                    <label for="capacidade">Capacidade:</label>
                                    <input type="number" class="form-control" min="1" id="capacidade" name="capacidade" placeholder="Capacidade da Sala" required>
                                </div>
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                for (StatusModel statusModel: statusList) {
                                                    out.print("<option value='" + statusModel.getIdStatus() + "'>" + statusModel.getDescricao() + "</option>");
                                                }
                                            } catch (Exception e) {
                                                e.printStackTrace();
                                            }
