                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-3">
                            <a class="btn btn-info link-btn" href="salas.jsp">
                        ...
                        <div class="col-lg-12 mt-4">
                            <form action="editar" method="POST">
                                <input type="text" name="idSala" value="<% out.print(salaModel.getIdSala()); %>" hidden>

                                <div class="form-group">
                                    <label for="descricao">Descrição:</label>
                                    <input type="text" class="form-control" id="descricao" name="descricao" value="<% out.print(salaModel.getDescricao()); %>" placeholder="Descrição da Sala" required>
                                </div>

                                <div class="form-group">
                                    <label for="capacidade">Capacidade:</label>
                                    <input type="number" class="form-control" min="1" id="capacidade" name="capacidade" value="<% out.print(salaModel.getCapacidade()); %>" placeholder="Capacidade da Sala" required>
                                </div>

                                <div class="form-group">
                                    <label for="status">Status:</label>
                                    <select class="form-control" id="status" name="status" required>
                                        <option value="" disabled selected>Status da Sala</option>

                                        <%
                                            StatusData statusData = new StatusData();

                                            try {
                                                List<StatusModel> statusList = statusData.listar();

                                                for (StatusModel statusModel: statusList) {
                                                    String statusSelected = salaModel.getStatus().getIdStatus() == statusModel.getIdStatus() ? "selected" : "";
                                                    out.print("<option value='" + statusModel.getIdStatus() + "' " + statusSelected + ">" + statusModel.getDescricao() + "</option>");
                                                }
                                            } catch (Exception e) {
                                                e.printStackTrace();
                                            }
